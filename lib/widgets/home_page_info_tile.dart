      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text('writer',style: TextStyle(color: Colors.black38,fontWeight: FontWeight.bold),),
              Text('time elapsed',style: TextStyle(color: Colors.black38,fontWeight: FontWeight.bold),)
            ],
          ),
        )
      ],
